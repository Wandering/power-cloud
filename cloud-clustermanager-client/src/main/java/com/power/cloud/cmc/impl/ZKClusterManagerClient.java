package com.power.cloud.cmc.impl;
...
import com.power.cloud.cmc.ClusterManagerClientFactory;
import com.power.cloud.cmc.IClusterManagerClient;
...
import com.power.cloud.dynclient.domain.Configuration;
...
public class ZKClusterManagerClient implements IClusterManagerClient {
    ...
    /** 云管理中心域名 */
    public static final String DEFAULT_DOMAIN_NAME = "mc.zk.power.com";
